    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($query) {
                $edit = "<a href='" . route('admin.delivery-area.edit', $query->id) . "' class='btn btn-primary'>
            <i class='fas fa-edit'></i></a>";
                $delete = "<a href='" . route('admin.delivery-area.destroy', $query->id) . "' class='btn btn-danger delete-item ml-2'>
