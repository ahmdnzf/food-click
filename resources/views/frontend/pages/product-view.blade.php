                ...
                <div class="col-lg-7 wow fadeInUp" data-wow-duration="1s">
                    <div class="fp__menu_details_text">
                        ...
                        <h3 class="price">
                            ...
                            @else
                                {{ currencyPosition(number_format($product->price, 2)) }}
                            @endif
                        </h3>
                        ...
                        <form action="" id="v_add_to_cart_form">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="size-{{ $productSize->id }}">
                                                {{ $productSize->name }} <span>+
                                                    {{ currencyPosition(number_format($productSize->price , 2)) }}</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="option-{{ $productOption->id }}">
                                                {{ $productOption->name }} <span>+
                                                    {{ currencyPosition(number_format($productOption->price,2)) }}</span>
                                            </label>
                                        </div>
                                    @endforeach
                                </div>
                            ...
                            <div class="details_quentity">
                                ...
                                <div class="quentity_btn_area d-flex flex-wrapa align-items-center">
                                    ...
                                    <h3 id="v_total_price">
                                        {{ $product->offer_price > 0 ? currencyPosition(number_format($product->offer_price,2)) : currencyPosition(number_format($product->price,2)) }}
                                    </h3>
                                </div>
                            </div>
                        </form>
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // Event handlers for increment button
            ...
            // Event handlers for decrement button
