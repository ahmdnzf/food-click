            ...
            <div class="row">
                                                    ...
                                                    <form action="{{ route('address.store') }}" method="POST">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div style="display:flex;">
                                                                <button style="100px" type="button"
                                                                    class="common_btn cancel_new_address mx-2">cancel</button>
                                                                <button style="100px" type="submit"
                                                                    class="common_btn mx-2">save
                                                                    address</button>
                                                            </div>
                                                        </div>
                                                    </form>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-duration="1s">
                    <div id="sticky_sidebar" class="fp__cart_list_footer_button">
                        ...
                        <p>delivery: <span id="delivery_fee">RM0.00</span></p>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.v_address').on('click', function() {
                ...
                $.ajax({
                    method: 'GET',
                    url: '{{ route("checkout.delivery-calc", ":id") }}'.replace(":id", addressId),
                    beforeSend: function() {
                        showLoader()
                    },
