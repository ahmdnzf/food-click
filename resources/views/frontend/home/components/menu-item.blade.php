        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_45">
                    ...
                    <h2>Discover Your Next Favorite Dish Based on Your Tastes</h2>
                    <span>
                        <img src="images/heading_shapes.png" alt="shapes" class="img-fluid w-100">
                    </span>
                    <p>We’ve handpicked a selection of delicious foods from categories you’ve loved before.
                        Explore your personalized menu and enjoy a seamless dining experience, crafted to match your
        ...
        @else
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>No categories available based on your purchase history.</p>
                </div>
            </div>
        @endif
    </div>
