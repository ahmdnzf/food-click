...
<head>
    ...
    <link rel="stylesheet" href="//cdn.datatables.net/2.1.8/css/dataTables.bootstrap4.min.css">
...
<body>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; {{ date('Y') }} <div class="bullet"></div> Developed By
                    <a href="https://github.com/ahmdnzf">Ahmad Nazif</a>
                </div>
    ...
    <script src="//cdn.datatables.net/2.1.8/js/dataTables.bootstrap4.min.js"></script>
